...
var timer = {
    ...
    reset: function () {
        timer.time = 10;
        $("#timer").text(timer.time) // Refreshes timer
    },
    start: function () {
        if (!clockRunning) {
...
$(document).on("click", ".answer", function () {
    ...
    //if they don't answer the question in the amoutn of time, player gets docked
    //keep score of wrong and right
});
